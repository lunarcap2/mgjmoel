	...
	<div class="recruit-detail">
		<script>
			$(document).ready(function () {
				setTimeout(function(){
				var tempalteWidth = 886;
				var templateHeight = $('#view_wrap').outerHeight();
				var deviceWidth = $('body').outerWidth() - 40;
				...
				// $('.hire.guide').append('<div>'+$('body').outerWidth()+'</div>')
				// $('.hire.guide').append('<div>'+window.innerWidth+'</div>')
				// $('.hire.guide').append('<div>'+deviceWidth+'</div>')
				// $('.hire.guide').append('<div>'+tempalteWidth+'</div>')
				// $('.hire.guide').append('<div>'+ratio+'</div>')
			},0);
			})
		</script>
		<%
